declare module "@serialport/binding-abstract" {
    import { PortInfo, OpenOptions, BaseBinding } from "serialport";
     ...
     * Abstract binding
     */
    export default class AbstractBinding extends BaseBinding {
         ...
         * @returns Resolves after the port is opened and configured.
         */
         ...
         * @returns Resolves with the number of bytes read after a read operation.
         */
        read(
            buffer: Buffer,
            offset: number,
         ...
         * @param buffer - - Accepts a [`Buffer`](http://nodejs.org/api/buffer.html) object.
         * @returns Resolves after the data is passed to the operating system for writing.
         */
        write(buffer: Buffer): Promise<void>;

        /**
         * Changes connection settings on an open port. Only `baudRate` is supported.
         * @returns Resolves once the port's baud rate changes.
         */
        update(options: { baudRate: number }): Promise<void>;

        /**
         * Set control flags on an open port.
         * @param options - All options are operating system default when the port is opened.
         * Every flag is set on each call to the provided or default values. All options are always provided.
         * @returns Resolves once the port's flags are set.
         */
        set(options: Partial<Flags>): Promise<void>;

        /**
         * Get the control flags (CTS, DSR, DCD) on the open port.
         * @returns Resolves with the retrieved flags.
         */
        get(): Promise<Flags>;
         ...
         * @returns Resolves once the flush operation finishes.
         */
        flush(): Promise<void>;
         ...
         * @returns Resolves once the drain operation finishes.
         */
        drain(): Promise<void>;
    }
}
